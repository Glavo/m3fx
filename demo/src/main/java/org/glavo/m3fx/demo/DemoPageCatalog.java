...
final class DemoPageCatalog {
    ...
    static @Unmodifiable List<DemoPage> createPages(DemoPageContext context) {
        ...
        return List.of(
                ...
                new DemoPage("Status Lights", "Status lights", ADDITIONAL_DEMOS_GROUP, "Semantic and categorical status indicators with descriptive labels", DemoMaterialDocs.STATUS_LIGHTS, "Spectrum docs", (new StatusLightsDemoPage(context))::createContent),
                new DemoPage("Table Views", "Table views", ADDITIONAL_DEMOS_GROUP, "Virtualized tabular data with sorting, resizing, selection, and Material rows", DemoMaterialDocs.TABLE_VIEWS, "Spectrum docs", (new TableViewsDemoPage(context))::createContent),
                new DemoPage("Tree Views", "Tree views", ADDITIONAL_DEMOS_GROUP, "Expandable hierarchies with Material rows and explicit selection styles", DemoMaterialDocs.TREE_VIEWS, "Spectrum docs", (new TreeViewsDemoPage(context))::createContent),
