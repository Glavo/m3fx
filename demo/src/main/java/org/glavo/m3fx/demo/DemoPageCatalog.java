...
final class DemoPageCatalog {
    ...
    static @Unmodifiable List<DemoPage> createPages(DemoPageContext context) {
        ...
        return List.of(
                ...
                new DemoPage("Meters", "Meters", ADDITIONAL_DEMOS_GROUP, "User-determined quantities with semantic, size, and label-placement options", DemoMaterialDocs.METERS, "Spectrum docs", (new MetersDemoPage(context))::createContent),
