...
final class DemoPageCatalog {
    ...
    static @Unmodifiable List<DemoPage> createPages(DemoPageContext context) {
        ...
        return List.of(
                ...
                new DemoPage("Tree Views", "Tree views", ADDITIONAL_DEMOS_GROUP, "Expandable virtualized hierarchies with standard and detached Material rows", DemoMaterialDocs.TREE_VIEWS, "Spectrum docs", (new TreeViewsDemoPage(context))::createContent),
