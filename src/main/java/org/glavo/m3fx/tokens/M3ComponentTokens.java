...
public sealed interface M3ComponentTokens permits M3ComponentTokensImpl {
    ...
    default String toControlStyleRules() {
        ...
        appendGroupSpacingRule(
                ...
                floatingActionButton().menuCloseSpacing()
        );
        ...
        appendFabRule(
                ...
                floatingActionButton().menuCloseButton()
        );
        ...
        appendSliderRules(builder, slider());
    ...
    private static void append(StringBuilder builder, FabTokens tokens) {
        ...
        M3TokenCss.append(builder, "-m3-fab-menu-close-spacing", M3TokenCss.pixels(tokens.menuCloseSpacing()));
    }
    ...
    private static void append(StringBuilder builder, String name, FabSizeTokens tokens) {
        ...
        M3TokenCss.append(builder, prefix + "-container-size", M3TokenCss.pixels(tokens.containerSize()));
        M3TokenCss.append(builder, prefix + "-container-shape", M3TokenCss.pixels(tokens.containerShape()));
        M3TokenCss.append(builder, prefix + "-icon-size", M3TokenCss.pixels(tokens.iconSize()));
        M3TokenCss.append(builder, prefix + "-leading-space", M3TokenCss.pixels(tokens.leadingSpace()));
        M3TokenCss.append(builder, prefix + "-icon-label-space", M3TokenCss.pixels(tokens.iconLabelSpace()));
        M3TokenCss.append(builder, prefix + "-trailing-space", M3TokenCss.pixels(tokens.trailingSpace()));
    }
    ...
    private static void append(StringBuilder builder, SliderTokens tokens) {
        ...
        M3TokenCss.append(builder, "-m3-slider-track-thickness", M3TokenCss.pixels(defaultSize.trackThickness()));
        M3TokenCss.append(builder, "-m3-slider-track-shape", M3TokenCss.pixels(defaultSize.trackShape()));
        M3TokenCss.append(
                builder,
        ...
        M3TokenCss.append(
                ...
                M3TokenCss.pixels(tokens.stopIndicatorTrailingSpace())
        );
        M3TokenCss.append(builder, "-m3-slider-thumb-size", M3TokenCss.pixels(defaultSize.thumbSize()));
        M3TokenCss.append(builder, "-m3-slider-thumb-width", M3TokenCss.pixels(tokens.thumbWidth()));
        M3TokenCss.append(
                builder,
                "-m3-slider-focused-thumb-width",
                M3TokenCss.pixels(tokens.focusedThumbWidth())
        );
        M3TokenCss.append(
                builder,
                "-m3-slider-pressed-thumb-width",
                M3TokenCss.pixels(tokens.pressedThumbWidth())
        );
    ...
    private static void append(StringBuilder builder, ProgressTokens tokens) {
        ...
        M3TokenCss.append(
                ...
                M3TokenCss.pixels(tokens.waveIndicatorSize())
        );
        ...
        M3TokenCss.append(
                ...
                M3TokenCss.pixels(tokens.linearIndeterminateWavelength())
        );
    ...
    private static void appendFabRule(
        ...
        appendDeclaration(builder, "-m3-container-shape", M3TokenCss.pixels(tokens.containerShape()));
        appendDeclaration(builder, "-m3-fab-icon-size", M3TokenCss.pixels(tokens.iconSize()));
        appendDeclaration(builder, "-m3-horizontal-padding", M3TokenCss.pixels(tokens.leadingSpace()));
        appendDeclaration(builder, "-m3-trailing-padding", M3TokenCss.pixels(tokens.trailingSpace()));
        appendDeclaration(builder, "-fx-graphic-text-gap", M3TokenCss.pixels(tokens.iconLabelSpace()));
        appendDeclaration(builder, "-fx-background-radius", M3TokenCss.pixels(tokens.containerShape()));
        appendDeclaration(builder, "-fx-border-radius", M3TokenCss.pixels(tokens.containerShape()));
        endRule(builder);
    ...
    private static void appendSliderRules(StringBuilder builder, SliderTokens tokens) {
        ...
        appendDeclaration(builder, "-m3-focused-thumb-width", M3TokenCss.pixels(tokens.focusedThumbWidth()));
        appendDeclaration(builder, "-m3-pressed-thumb-width", M3TokenCss.pixels(tokens.pressedThumbWidth()));
        ...
        appendDeclaration(builder, "-m3-thumb-width", M3TokenCss.pixels(tokens.focusedThumbWidth()));
        endRule(builder);

        beginRule(builder, ".m3-slider:pressed");
        appendDeclaration(builder, "-m3-thumb-width", M3TokenCss.pixels(tokens.pressedThumbWidth()));
        endRule(builder);
    ...
    private static void appendSliderSizeRule(
        ...
        appendDeclaration(builder, "-m3-slider-icon-size", M3TokenCss.pixels(tokens.iconSize()));
        appendDeclaration(builder, "-m3-slider-icon-padding", M3TokenCss.pixels(tokens.iconPadding()));
        endRule(builder);
    }
    ...
    private static void appendProgressBarRule(StringBuilder builder, ProgressTokens tokens) {
        ...
        appendDeclaration(builder, "-m3-wave-amplitude", M3TokenCss.pixels(0.0));
    ...
    private static void appendProgressIndicatorRule(StringBuilder builder, ProgressTokens tokens) {
        ...
        appendDeclaration(builder, "-m3-wave-indicator-size", M3TokenCss.pixels(tokens.waveIndicatorSize()));
        appendDeclaration(builder, "-m3-wave-amplitude", M3TokenCss.pixels(0.0));
