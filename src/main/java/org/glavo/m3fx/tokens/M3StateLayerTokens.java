...
public sealed interface M3StateLayerTokens permits M3StateLayerTokensImpl {
    ...
    private static String focusStateSelectors() {
        return ".m3-button:m3-focus-visible .m3-state-layer, .m3-chip:m3-focus-visible .m3-state-layer, "
                + ".m3-icon-button:m3-focus-visible .m3-state-layer, .m3-fab:m3-focus-visible .m3-state-layer, "
                + ".m3-segmented-button:m3-focus-visible .m3-state-layer, .m3-checkbox:m3-focus-visible .m3-state-layer, "
                + ".m3-radio-button:m3-focus-visible .m3-state-layer, .m3-switch:m3-focus-visible .m3-state-layer, "
                + ".m3-slider:m3-focus-visible .m3-state-layer, .m3-list-item:m3-focus-visible .m3-state-layer, "
                + ".m3-card:m3-focus-visible .m3-state-layer";
    }
