...
///
/// These methods use English labels and receive explicit anchor values so their results are deterministic.
/// Applications that require localized labels can create [M3DateRangePreset] values directly. Every returned
...
public final class M3DateRangePresets {
    ...
    /// @throws IllegalArgumentException if `dayCount` is not positive
