...
/// the M3FX scroll stylesheet and installs smooth wheel handling. Fit policies, scrollbar policies, pannability,
/// focus traversal, and content sizing retain their inherited JavaFX defaults.
///
/// The static methods apply the same presentation and input behavior to existing JavaFX [ScrollPane] instances and
/// style standalone [ScrollBar] instances. Styling and smooth scrolling remain independently controllable:
...
public final class M3ScrollPane extends ScrollPane {
    ...
    /// [#style(ScrollPane)] separately when both behaviors are required.
    ///
    ...
    /// method for a pane that is not enabled has no effect and does not remove visual styling.
    ///
