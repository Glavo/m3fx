...
- Inputs: filled and outlined text fields, password fields, text areas, shared error-state support, and text input layouts with floating labels, leading/trailing adornments, supporting text, error text, character counters, clear buttons, and optional hard character limits.
...
- Continue filling component gaps such as richer list item media variants, richer popup nesting policies, and more complete text input validation affordances.
