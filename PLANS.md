...
- State layers, ripples, and CSS-resolved elevation transitions resolve the installed theme motion scheme when available. Running state-layer opacity and ripple animations settle immediately when inherited animation settings are disabled at runtime.
