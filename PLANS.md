...
- Overlay hosts support default accessibility reveal behavior: FAB menus expand and focus the first reachable action for parameterless `SHOW_ITEM`, and snackbar hosts refresh hosted snackbar skins before routing focus to current or queued snackbar actions.
