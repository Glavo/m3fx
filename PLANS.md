...
- Button tests cover elevation ownership so filled, tonal, outlined, text, and snackbar action buttons do not retain elevated-button shadows or pressed container scaling across interactive states or variant changes.
