...
- Build M3FX as a modular Material Design 3 component library for Java 17 and JavaFX 21 by default.
- Keep the public implementation source-compatible with JavaFX 14 APIs.
...
- Implement first core controls:
  ...
  - Provide convenience constructors, static factories, and index-based selection helpers for common composition-heavy controls such as cards, app bars, menu buttons, menu items, search views, sheets, lists, menus, tabs, navigation containers, chips, segmented buttons, icon toggle button groups, and common leaf controls, while keeping all node ownership explicit through mutable child lists.
